...
public class GAConfig {
    ...
    public static final double DEFAULT_CROSSOVER_RATE = 0.3; // 默认交叉率
    public static final double DEFAULT_MUTATION_RATE = 0.95; // 默认变异率
    public static final int DEFAULT_MAX_GENERATION = 500; // 默认最大代数

    // 收敛配置
    public static final int DEFAULT_MAX_NON_IMPROVE = 100; // 默认连续无改进代数
    public static final double DEFAULT_IMPROVEMENT_THRESHOLD = 0.00001; // 默认改进阈值 (0.01%)
