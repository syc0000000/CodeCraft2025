...
if [ "$(uname -s)" = "Darwin" ]; then
    ...
    # 其他系统
    python3 ./test/run.py ./test/interactor $INPUT_FILE "java -cp ./build Main -load distributions/distribution_20250328_153137.ser" $DEBUG_OPTION -r 25000 40000 60000 80000
fi
